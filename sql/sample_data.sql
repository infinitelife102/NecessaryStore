...
((SELECT id FROM vendors WHERE store_slug = 'techworld-store'), (SELECT id FROM categories WHERE slug = 'smartphones'), 'iPhone 15 Pro Max', 'iphone-15-pro-max', 'The most advanced iPhone ever. Featuring a titanium design, A17 Pro chip, and an incredible camera system.', 'Latest iPhone with titanium design and A17 Pro chip', 1199.00, 1299.00, 50, 'IPH15-PM-001', ARRAY['https://images.unsplash.com/photo-1695638297240-2ea1126e2bd9?w=600', 'https://images.unsplash.com/photo-1695638297240-2ea1126e2bd9?w=600'], 'https://images.unsplash.com/photo-1695638297240-2ea1126e2bd9?w=600', 4.8, 128, 342, true, true, ARRAY['smartphone', 'apple', 'iphone', '5g']),

((SELECT id FROM vendors WHERE store_slug = 'techworld-store'), (SELECT id FROM categories WHERE slug = 'smartphones'), 'Samsung Galaxy S24 Ultra', 'samsung-galaxy-s24-ultra', 'The ultimate Galaxy experience with AI-powered features, S Pen, and 200MP camera.', 'AI-powered smartphone with S Pen and 200MP camera', 1299.00, 1399.00, 45, 'SAM-S24U-001', ARRAY['https://images.unsplash.com/photo-1705587256226-1554d3b9d843?w=600', 'https://images.unsplash.com/photo-1705587256226-1554d3b9d843?w=600'], 'https://images.unsplash.com/photo-1705587256226-1554d3b9d843?w=600', 4.7, 96, 278, true, true, ARRAY['smartphone', 'samsung', 'android', '5g']),

((SELECT id FROM vendors WHERE store_slug = 'techworld-store'), (SELECT id FROM categories WHERE slug = 'smartphones'), 'Google Pixel 8 Pro', 'google-pixel-8-pro', 'The smartest Pixel yet with Google AI and the best camera on a Pixel phone.', 'Google AI-powered phone with best-in-class camera', 999.00, 1099.00, 60, 'PIX-8P-001', ARRAY['https://images.unsplash.com/photo-1695638297240-2ea1126e2bd9?w=600', 'https://images.unsplash.com/photo-1705587256226-1554d3b9d843?w=600'], 'https://images.unsplash.com/photo-1695638297240-2ea1126e2bd9?w=600', 4.6, 84, 195, false, true, ARRAY['smartphone', 'google', 'pixel', 'android']),

((SELECT id FROM vendors WHERE store_slug = 'techworld-store'), (SELECT id FROM categories WHERE slug = 'smartphones'), 'OnePlus 12', 'oneplus-12', 'Fast and smooth performance with Snapdragon 8 Gen 3 and 100W charging.', 'Flagship performance with ultra-fast charging', 799.00, 899.00, 80, 'OP-12-001', ARRAY['https://images.unsplash.com/photo-1705587256226-1554d3b9d843?w=600', 'https://images.unsplash.com/photo-1632287713678-3eccd7731c8d?w=600'], 'https://images.unsplash.com/photo-1632287713678-3eccd7731c8d?w=600', 4.5, 62, 156, false, true, ARRAY['smartphone', 'oneplus', 'android', 'fast-charge']),

((SELECT id FROM vendors WHERE store_slug = 'techworld-store'), (SELECT id FROM categories WHERE slug = 'smartphones'), 'Xiaomi 14 Ultra', 'xiaomi-14-ultra', 'Professional photography phone with Leica optics and 1-inch sensor.', 'Leica-powered camera phone for photography enthusiasts', 1099.00, 1199.00, 35, 'XM-14U-001', ARRAY['https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=600', 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=600'], 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=600', 4.4, 45, 89, false, true, ARRAY['smartphone', 'xiaomi', 'leica', 'camera']);
...
((SELECT id FROM vendors WHERE store_slug = 'techworld-store'), (SELECT id FROM categories WHERE slug = 'laptops'), 'Dell XPS 15', 'dell-xps-15', 'Premium laptop with InfinityEdge display and powerful performance.', 'Premium Windows laptop with stunning display', 1899.00, 2199.00, 40, 'DELL-XPS15', ARRAY['https://images.unsplash.com/photo-1593642632823-8f78536788c6?w=600', 'https://images.unsplash.com/photo-1593642632823-8f78536788c6?w=600'], 'https://images.unsplash.com/photo-1593642632823-8f78536788c6?w=600', 4.6, 89, 234, true, true, ARRAY['laptop', 'dell', 'windows', 'premium']),

((SELECT id FROM vendors WHERE store_slug = 'techworld-store'), (SELECT id FROM categories WHERE slug = 'laptops'), 'Lenovo ThinkPad X1 Carbon', 'lenovo-thinkpad-x1-carbon', 'Ultra-light business laptop with legendary ThinkPad reliability.', 'Ultra-light business laptop', 1699.00, 1899.00, 55, 'TP-X1C-001', ARRAY['https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=600', 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=600'], 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=600', 4.7, 112, 312, false, true, ARRAY['laptop', 'lenovo', 'thinkpad', 'business']),

((SELECT id FROM vendors WHERE store_slug = 'techworld-store'), (SELECT id FROM categories WHERE slug = 'laptops'), 'ASUS ROG Zephyrus G14', 'asus-rog-zephyrus-g14', 'Compact gaming powerhouse with RTX 4070 and AMD Ryzen 9.', 'Compact gaming laptop with RTX 4070', 1799.00, 1999.00, 30, 'ASUS-G14-001', ARRAY['https://images.unsplash.com/photo-1603302576837-37561b2e2302?w=600', 'https://images.unsplash.com/photo-1603302576837-37561b2e2302?w=600'], 'https://images.unsplash.com/photo-1603302576837-37561b2e2302?w=600', 4.5, 78, 189, false, true, ARRAY['laptop', 'asus', 'gaming', 'rtx']),

((SELECT id FROM vendors WHERE store_slug = 'techworld-store'), (SELECT id FROM categories WHERE slug = 'laptops'), 'HP Spectre x360', 'hp-spectre-x360', 'Versatile 2-in-1 laptop with stunning design and all-day battery.', 'Premium 2-in-1 convertible laptop', 1499.00, 1699.00, 45, 'HP-S360-001', ARRAY['https://images.unsplash.com/photo-1544731612-de7f96afe55f?w=600', 'https://images.unsplash.com/photo-1544731612-de7f96afe55f?w=600'], 'https://images.unsplash.com/photo-1544731612-de7f96afe55f?w=600', 4.4, 67, 145, false, true, ARRAY['laptop', 'hp', '2-in-1', 'convertible']);

-- Audio (5 products) - these were already quite good, minor tweaks only if needed
INSERT INTO products (vendor_id, category_id, name, slug, description, short_description, price, compare_at_price, inventory_quantity, sku, images, featured_image, rating, review_count, total_sales, is_featured, is_active, tags) VALUES
...
-- Cameras (5 products)
INSERT INTO products (vendor_id, category_id, name, slug, description, short_description, price, compare_at_price, inventory_quantity, sku, images, featured_image, rating, review_count, total_sales, is_featured, is_active, tags) VALUES
((SELECT id FROM vendors WHERE store_slug = 'techworld-store'), (SELECT id FROM categories WHERE slug = 'cameras'), 'Sony A7 IV', 'sony-a7-iv', 'Full-frame mirrorless camera with 33MP sensor and 4K 60p video.', 'Professional full-frame mirrorless camera', 2498.00, 2798.00, 20, 'SONY-A7IV', ARRAY['https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=600', 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=600'], 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=600', 4.8, 87, 198, true, true, ARRAY['camera', 'sony', 'mirrorless', 'full-frame']),

((SELECT id FROM vendors WHERE store_slug = 'techworld-store'), (SELECT id FROM categories WHERE slug = 'cameras'), 'Canon EOS R6 Mark II', 'canon-eos-r6-mark-ii', 'Versatile full-frame mirrorless with 40fps burst and 4K 60p video.', 'Versatile full-frame mirrorless', 2499.00, 2799.00, 18, 'CAN-R6II-001', ARRAY['https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=600', 'https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=600'], 'https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=600', 4.7, 76, 167, true, true, ARRAY['camera', 'canon', 'mirrorless', 'full-frame']),

((SELECT id FROM vendors WHERE store_slug = 'techworld-store'), (SELECT id FROM categories WHERE slug = 'cameras'), 'Fujifilm X-T5', 'fujifilm-x-t5', 'Classic design with 40MP APS-C sensor and film simulations.', 'Classic design with 40MP sensor', 1699.00, 1899.00, 30, 'FUJ-XT5-001', ARRAY['https://images.unsplash.com/photo-1519638831568-d9897f54ed69?w=600', 'https://images.unsplash.com/photo-1519638831568-d9897f54ed69?w=600'], 'https://images.unsplash.com/photo-1519638831568-d9897f54ed69?w=600', 4.6, 54, 123, false, true, ARRAY['camera', 'fujifilm', 'mirrorless', 'aps-c']),

((SELECT id FROM vendors WHERE store_slug = 'techworld-store'), (SELECT id FROM categories WHERE slug = 'cameras'), 'GoPro Hero 12 Black', 'gopro-hero-12-black', 'Ultimate action camera with 5.3K video and HyperSmooth 6.0.', 'Ultimate action camera', 399.00, 449.00, 80, 'GPRO-12-001', ARRAY['https://images.unsplash.com/photo-1564466021188-1e1a5f48a3be?w=600', 'https://images.unsplash.com/photo-1564466021188-1e1a5f48a3be?w=600'], 'https://images.unsplash.com/photo-1564466021188-1e1a5f48a3be?w=600', 4.5, 145, 389, false, true, ARRAY['camera', 'gopro', 'action', 'waterproof']),

((SELECT id FROM vendors WHERE store_slug = 'techworld-store'), (SELECT id FROM categories WHERE slug = 'cameras'), 'DJI Mini 4 Pro', 'dji-mini-4-pro', 'Lightweight drone with 4K/60fps HDR video and omnidirectional sensing.', 'Lightweight 4K drone with HDR', 759.00, 899.00, 45, 'DJI-M4P-001', ARRAY['https://images.unsplash.com/photo-1473968512647-3e447244af8f?w=600', 'https://images.unsplash.com/photo-1473968512647-3e447244af8f?w=600'], 'https://images.unsplash.com/photo-1473968512647-3e447244af8f?w=600', 4.7, 89, 234, false, true, ARRAY['drone', 'dji', '4k', 'camera']);
